...
const allowedOrigins = ['https://graceful-crumble-1f87ec.netlify.app', 'https://golden-haupia-4e2758.netlify.app/', 'http://localhost:3000', 'https://real-time-quiz-9tdsvyooa-andreusshs-projects.vercel.app'];
app.use(cors({
